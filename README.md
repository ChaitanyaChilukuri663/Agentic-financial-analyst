...
| **P3** | EDGAR HTML/iXBRL ingestion ✅ (real 10-K → unit-aware tables + item sections + XBRL grounding); table-aware hybrid RAG + retrieval eval + FinanceBench — next | 🟡 ingestion done |
